...
const Categories = [
    { key: 1, value: "Books" },
    { key: 2, value: "Rooms" },
    { key: 3, value: "Notes/Qp" },
    { key: 4, value: "Study-Materials" }
]

export class UpdateProductPage extends Component {
    ...
    onSubmit = (event) => {
        ...
        if (!this.state.title || !this.state.description ||
            !this.state.categories || !this.state.price) {
        ...
        const variables = {
            ...
            categories: this.state.continents,
